...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Encoded By :- @Sb_Botz_Update" -metadata author="@Your_Raj" -metadata:s:s title="Subtitled By :- @Sb_Botz_Update" -metadata:s:a title="By :- @Sb_Botz_Update" -metadata:s:v title="Encoded By :- @Sb_Botz_Update" """
        )
